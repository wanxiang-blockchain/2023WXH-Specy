...
export interface V1Beta1ContractInfoByPoolIdResponse {
  /**
 ...
 */
export interface V1Beta1MsgCreateCosmWasmPoolResponse {
  /** @format uint64 */
  pool_id?: string;
}
...
/**
 * @title osmosis/cosmwasmpool/v1beta1/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags Query
   * @name QueryContractInfoByPoolId
   * @request GET:/osmosis/cosmwasmpool/v1beta1/contract_info
   */
  queryContractInfoByPoolId = (query?: { pool_id?: string }, params: RequestParams = {}) =>
    this.request<V1Beta1ContractInfoByPoolIdResponse, RpcStatus>({
   ...
   * @tags Query
   * @name QueryParams
   * @summary Params returns the parameters of the x/cosmwasmpool module.
   * @request GET:/osmosis/cosmwasmpool/v1beta1/params
   */
   ...
   * @tags Query
   * @name QueryPools
   * @summary Pools returns all cosmwasm pools
   * @request GET:/osmosis/cosmwasmpool/v1beta1/pools
   */
  queryPools = (
    query?: {
