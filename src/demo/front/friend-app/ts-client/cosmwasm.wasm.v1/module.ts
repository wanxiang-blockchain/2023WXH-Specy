...
export { MsgUpdateAdmin, MsgIBCSend, MsgIBCCloseChannel, MsgInstantiateContract2, MsgExecuteContract, MsgUpdateInstantiateConfig, MsgInstantiateContract, MsgClearAdmin, MsgStoreCode, MsgMigrateContract };
