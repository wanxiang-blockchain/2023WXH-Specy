...
function createBaseGenesisState(): GenesisState {
  return { minter: undefined, params: undefined, reductionStartedEpoch: 0 };
}
...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      reductionStartedEpoch: isSet(object.reductionStartedEpoch) ? Number(object.reductionStartedEpoch) : 0,
    };
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    message.reductionStartedEpoch !== undefined
      && (obj.reductionStartedEpoch = Math.round(message.reductionStartedEpoch));
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(object: I): GenesisState {
    ...
    message.params = (object.params !== undefined && object.params !== null)
      ...
      : undefined;
    message.reductionStartedEpoch = object.reductionStartedEpoch ?? 0;
    return message;
  },
};
