  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      superfluidAssets: Array.isArray(object?.superfluidAssets)
        ...
        : [],
      osmoEquivalentMultipliers: Array.isArray(object?.osmoEquivalentMultipliers)
      ...
      intermediaryAccounts: Array.isArray(object?.intermediaryAccounts)
        ...
        : [],
      intemediaryAccountConnections: Array.isArray(object?.intemediaryAccountConnections)
