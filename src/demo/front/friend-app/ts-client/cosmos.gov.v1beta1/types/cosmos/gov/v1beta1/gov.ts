...
function createBaseDepositParams(): DepositParams {
  return { minDeposit: [], maxDepositPeriod: undefined, minExpeditedDeposit: [], minInitialDepositRatio: "" };
}
...
export const DepositParams = {
  ...
  fromJSON(object: any): DepositParams {
    return {
      ...
      minExpeditedDeposit: Array.isArray(object?.minExpeditedDeposit)
        ? object.minExpeditedDeposit.map((e: any) => Coin.fromJSON(e))
        : [],
...
function createBaseVotingParams(): VotingParams {
  return { votingPeriod: undefined, proposalVotingPeriods: [], expeditedVotingPeriod: undefined };
}
...
export const VotingParams = {
  ...
  fromJSON(object: any): VotingParams {
    return {
      ...
      proposalVotingPeriods: Array.isArray(object?.proposalVotingPeriods)
        ? object.proposalVotingPeriods.map((e: any) => ProposalVotingPeriod.fromJSON(e))
        : [],
  ...
  toJSON(message: VotingParams): unknown {
    ...
    if (message.proposalVotingPeriods) {
      obj.proposalVotingPeriods = message.proposalVotingPeriods.map((e) =>
  ...
  fromJSON(object: any): TallyParams {
    return {
      ...
      expeditedThreshold: isSet(object.expeditedThreshold)
        ? bytesFromBase64(object.expeditedThreshold)
        : new Uint8Array(),
  ...
  toJSON(message: TallyParams): unknown {
    ...
    message.expeditedThreshold !== undefined
      && (obj.expeditedThreshold = base64FromBytes(
        message.expeditedThreshold !== undefined ? message.expeditedThreshold : new Uint8Array(),
      ));
    message.expeditedQuorum !== undefined
      && (obj.expeditedQuorum = base64FromBytes(
        message.expeditedQuorum !== undefined ? message.expeditedQuorum : new Uint8Array(),
      ));
    return obj;
  },
...
function createBaseProposalVotingPeriod(): ProposalVotingPeriod {
  return { proposalType: "", votingPeriod: undefined };
}
...
export const ProposalVotingPeriod = {
  ...
  fromPartial<I extends Exact<DeepPartial<ProposalVotingPeriod>, I>>(object: I): ProposalVotingPeriod {
    const message = createBaseProposalVotingPeriod();
