...
export function txRecord_TxActionToJSON(object: TxRecord_TxAction): string {
  switch (object) {
    ...
    case TxRecord_TxAction.REMOVED:
      return "REMOVED";
    case TxRecord_TxAction.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export const Request = {
  encode(message: Request, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.initChain !== undefined) {
      RequestInitChain.encode(message.initChain, writer.uint32(34).fork()).ldelim();
    }
    if (message.query !== undefined) {
      RequestQuery.encode(message.query, writer.uint32(42).fork()).ldelim();
    }
    if (message.beginBlock !== undefined) {
      RequestBeginBlock.encode(message.beginBlock, writer.uint32(50).fork()).ldelim();
    }
    if (message.checkTx !== undefined) {
      RequestCheckTx.encode(message.checkTx, writer.uint32(58).fork()).ldelim();
    }
    if (message.deliverTx !== undefined) {
      RequestDeliverTx.encode(message.deliverTx, writer.uint32(66).fork()).ldelim();
    }
    if (message.endBlock !== undefined) {
      RequestEndBlock.encode(message.endBlock, writer.uint32(74).fork()).ldelim();
    }
    if (message.commit !== undefined) {
      RequestCommit.encode(message.commit, writer.uint32(82).fork()).ldelim();
    }
    if (message.listSnapshots !== undefined) {
      RequestListSnapshots.encode(message.listSnapshots, writer.uint32(90).fork()).ldelim();
    }
    if (message.offerSnapshot !== undefined) {
      RequestOfferSnapshot.encode(message.offerSnapshot, writer.uint32(98).fork()).ldelim();
    }
    if (message.loadSnapshotChunk !== undefined) {
      RequestLoadSnapshotChunk.encode(message.loadSnapshotChunk, writer.uint32(106).fork()).ldelim();
    }
    if (message.applySnapshotChunk !== undefined) {
      RequestApplySnapshotChunk.encode(message.applySnapshotChunk, writer.uint32(114).fork()).ldelim();
    }
    if (message.prepareProposal !== undefined) {
      RequestPrepareProposal.encode(message.prepareProposal, writer.uint32(122).fork()).ldelim();
    }
    if (message.processProposal !== undefined) {
      RequestProcessProposal.encode(message.processProposal, writer.uint32(130).fork()).ldelim();
    }
    if (message.extendVote !== undefined) {
      RequestExtendVote.encode(message.extendVote, writer.uint32(138).fork()).ldelim();
    }
    if (message.verifyVoteExtension !== undefined) {
      RequestVerifyVoteExtension.encode(message.verifyVoteExtension, writer.uint32(146).fork()).ldelim();
    }
    if (message.finalizeBlock !== undefined) {
      RequestFinalizeBlock.encode(message.finalizeBlock, writer.uint32(154).fork()).ldelim();
    }
    return writer;
  },
...
function createBaseRequestExtendVote(): RequestExtendVote {
  return { hash: new Uint8Array(), height: 0 };
}
...
export const Response = {
  encode(message: Response, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.initChain !== undefined) {
      ResponseInitChain.encode(message.initChain, writer.uint32(42).fork()).ldelim();
    }
    if (message.query !== undefined) {
      ResponseQuery.encode(message.query, writer.uint32(50).fork()).ldelim();
    }
    if (message.beginBlock !== undefined) {
      ResponseBeginBlock.encode(message.beginBlock, writer.uint32(58).fork()).ldelim();
    }
    if (message.checkTx !== undefined) {
      ResponseCheckTx.encode(message.checkTx, writer.uint32(66).fork()).ldelim();
    }
    if (message.deliverTx !== undefined) {
      ResponseDeliverTx.encode(message.deliverTx, writer.uint32(74).fork()).ldelim();
    }
    if (message.endBlock !== undefined) {
      ResponseEndBlock.encode(message.endBlock, writer.uint32(82).fork()).ldelim();
    }
    if (message.commit !== undefined) {
      ResponseCommit.encode(message.commit, writer.uint32(90).fork()).ldelim();
    }
    if (message.listSnapshots !== undefined) {
      ResponseListSnapshots.encode(message.listSnapshots, writer.uint32(98).fork()).ldelim();
    }
    if (message.offerSnapshot !== undefined) {
      ResponseOfferSnapshot.encode(message.offerSnapshot, writer.uint32(106).fork()).ldelim();
    }
    if (message.loadSnapshotChunk !== undefined) {
      ResponseLoadSnapshotChunk.encode(message.loadSnapshotChunk, writer.uint32(114).fork()).ldelim();
    }
    if (message.applySnapshotChunk !== undefined) {
      ResponseApplySnapshotChunk.encode(message.applySnapshotChunk, writer.uint32(122).fork()).ldelim();
    }
    if (message.prepareProposal !== undefined) {
      ResponsePrepareProposal.encode(message.prepareProposal, writer.uint32(130).fork()).ldelim();
    }
    if (message.processProposal !== undefined) {
      ResponseProcessProposal.encode(message.processProposal, writer.uint32(138).fork()).ldelim();
    }
    if (message.extendVote !== undefined) {
      ResponseExtendVote.encode(message.extendVote, writer.uint32(146).fork()).ldelim();
    }
    if (message.verifyVoteExtension !== undefined) {
      ResponseVerifyVoteExtension.encode(message.verifyVoteExtension, writer.uint32(154).fork()).ldelim();
    }
    if (message.finalizeBlock !== undefined) {
      ResponseFinalizeBlock.encode(message.finalizeBlock, writer.uint32(162).fork()).ldelim();
    }
    return writer;
  },
...
export const ResponsePrepareProposal = {
  ...
  fromJSON(object: any): ResponsePrepareProposal {
    return {
      txRecords: Array.isArray(object?.txRecords) ? object.txRecords.map((e: any) => TxRecord.fromJSON(e)) : [],
      appHash: isSet(object.appHash) ? bytesFromBase64(object.appHash) : new Uint8Array(),
  ...
  toJSON(message: ResponsePrepareProposal): unknown {
    ...
    if (message.txRecords) {
      obj.txRecords = message.txRecords.map((e) => e ? TxRecord.toJSON(e) : undefined);
    } else {
      obj.txRecords = [];
    }
    message.appHash !== undefined
  ...
  fromPartial<I extends Exact<DeepPartial<ResponsePrepareProposal>, I>>(object: I): ResponsePrepareProposal {
    const message = createBaseResponsePrepareProposal();
    message.txRecords = object.txRecords?.map((e) => TxRecord.fromPartial(e)) || [];
    message.appHash = object.appHash ?? new Uint8Array();
...
function createBaseResponseFinalizeBlock(): ResponseFinalizeBlock {
  return { events: [], txResults: [], validatorUpdates: [], consensusParamUpdates: undefined };
}
...
function createBaseTxRecord(): TxRecord {
  return { action: 0, tx: new Uint8Array() };
}

export const TxRecord = {
  encode(message: TxRecord, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.action !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): TxRecord {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): TxRecord {
    return {
      action: isSet(object.action) ? txRecord_TxActionFromJSON(object.action) : 0,
      tx: isSet(object.tx) ? bytesFromBase64(object.tx) : new Uint8Array(),
    };
  },
  ...
  toJSON(message: TxRecord): unknown {
    const obj: any = {};
    message.action !== undefined && (obj.action = txRecord_TxActionToJSON(message.action));
    message.tx !== undefined && (obj.tx = base64FromBytes(message.tx !== undefined ? message.tx : new Uint8Array()));
    return obj;
  },
...
export class ABCIApplicationClientImpl implements ABCIApplication {
  ...
  ExtendVote(request: RequestExtendVote): Promise<ResponseExtendVote> {
    ...
    const promise = this.rpc.request("tendermint.abci.ABCIApplication", "ExtendVote", data);
    return promise.then((data) => ResponseExtendVote.decode(new _m0.Reader(data)));
  }

  VerifyVoteExtension(request: RequestVerifyVoteExtension): Promise<ResponseVerifyVoteExtension> {
    const data = RequestVerifyVoteExtension.encode(request).finish();
    const promise = this.rpc.request("tendermint.abci.ABCIApplication", "VerifyVoteExtension", data);
    return promise.then((data) => ResponseVerifyVoteExtension.decode(new _m0.Reader(data)));
  }

  FinalizeBlock(request: RequestFinalizeBlock): Promise<ResponseFinalizeBlock> {
    const data = RequestFinalizeBlock.encode(request).finish();
    const promise = this.rpc.request("tendermint.abci.ABCIApplication", "FinalizeBlock", data);
    return promise.then((data) => ResponseFinalizeBlock.decode(new _m0.Reader(data)));
  }
}
