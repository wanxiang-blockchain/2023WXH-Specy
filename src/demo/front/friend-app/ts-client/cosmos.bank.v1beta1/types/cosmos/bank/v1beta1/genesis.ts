...
function createBaseGenesisState(): GenesisState {
  return { params: undefined, balances: [], supply: [], denomMetadata: [], supplyOffsets: [] };
}
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      denomMetadata: Array.isArray(object?.denomMetadata)
        ...
        : [],
      supplyOffsets: Array.isArray(object?.supplyOffsets)
        ? object.supplyOffsets.map((e: any) => GenesisSupplyOffset.fromJSON(e))
        : [],
    };
  },
...
export const GenesisSupplyOffset = {
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisSupplyOffset>, I>>(object: I): GenesisSupplyOffset {
    const message = createBaseGenesisSupplyOffset();
