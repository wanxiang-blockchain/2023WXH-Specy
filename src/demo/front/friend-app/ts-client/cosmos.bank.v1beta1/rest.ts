 ...
 */
export interface V1Beta1QuerySupplyOfWithoutOffsetResponse {
  /** amount is the supply of the coin. */
  amount?: V1Beta1Coin;
}
...
export interface V1Beta1QueryTotalSupplyWithoutOffsetResponse {
  /** supply is the supply of the coins */
  supply?: V1Beta1Coin[];
 ...
 * @tags Query
 * @name QueryBaseDenom
 * @summary BaseDenom queries for a base denomination given a denom that can either be
the base denom itself or a metadata denom unit that maps to the base denom.
 * @request GET:/cosmos/bank/v1beta1/base_denom
 */
  queryBaseDenom = (query?: { denom?: string }, params: RequestParams = {}) =>
    this.request<V1Beta1QueryBaseDenomResponse, RpcStatus>({
      path: `/cosmos/bank/v1beta1/base_denom`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   *
   * @tags Query
   * @name QueryTotalSupplyWithoutOffset
   * @summary TotalSupplyWithoutOffset queries the total supply of all coins.
   * @request GET:/cosmos/bank/v1beta1/supply_without_offset
   */
  queryTotalSupplyWithoutOffset = (
    query?: {
      "pagination.key"?: string;
      "pagination.offset"?: string;
      "pagination.limit"?: string;
    ...
    this.request<V1Beta1QueryTotalSupplyWithoutOffsetResponse, RpcStatus>({
      path: `/cosmos/bank/v1beta1/supply_without_offset`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   *
   * @tags Query
   * @name QuerySupplyOfWithoutOffset
   * @summary SupplyOf queries the supply of a single coin.
   * @request GET:/cosmos/bank/v1beta1/supply_without_offset/{denom}
   */
  querySupplyOfWithoutOffset = (denom: string, params: RequestParams = {}) =>
    this.request<V1Beta1QuerySupplyOfWithoutOffsetResponse, RpcStatus>({
      path: `/cosmos/bank/v1beta1/supply_without_offset/${denom}`,
      method: "GET",
      format: "json",
      ...params,
    });
