...
export interface V1Beta1PoolParams {
   ...
   */
  exit_fee?: string;
  smooth_weight_change_params?: V1Beta1SmoothWeightChangeParams;
}
...
export interface V1Beta1SmoothWeightChangeParams {
   ...
   * here.
   */
  initial_pool_weights?: V1Beta1PoolAsset[];
   ...
   *  ];
   */
  target_pool_weights?: V1Beta1PoolAsset[];
}
...
/**
 * @title osmosis/gamm/pool-models/balancer/balancerPool.proto
