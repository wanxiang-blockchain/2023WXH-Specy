...
import { ConsensusParams as ConsensusParams1, EvidenceParams, ValidatorParams, VersionParams } from "../types/params";
...
export interface RequestInitChain {
  time: Date | undefined;
  chainId: string;
  consensusParams: ConsensusParams1 | undefined;
...
export interface ResponseEndBlock {
  ...
  consensusParamUpdates: ConsensusParams1 | undefined;
  events: Event[];
}
...
export const RequestInitChain = {
  encode(message: RequestInitChain, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.consensusParams !== undefined) {
      ConsensusParams1.encode(message.consensusParams, writer.uint32(26).fork()).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.consensusParams = ConsensusParams1.decode(reader, reader.uint32());
          break;
        case 4:
  ...
  fromJSON(object: any): RequestInitChain {
    return {
      ...
      consensusParams: isSet(object.consensusParams) ? ConsensusParams1.fromJSON(object.consensusParams) : undefined,
  ...
  toJSON(message: RequestInitChain): unknown {
    ...
    message.consensusParams !== undefined
      && (obj.consensusParams = message.consensusParams ? ConsensusParams1.toJSON(message.consensusParams) : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<RequestInitChain>, I>>(object: I): RequestInitChain {
    ...
    message.consensusParams = (object.consensusParams !== undefined && object.consensusParams !== null)
      ? ConsensusParams1.fromPartial(object.consensusParams)
      : undefined;
...
export const ResponseEndBlock = {
  encode(message: ResponseEndBlock, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.consensusParamUpdates !== undefined) {
      ConsensusParams1.encode(message.consensusParamUpdates, writer.uint32(18).fork()).ldelim();
    }
    for (const v of message.events) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.consensusParamUpdates = ConsensusParams1.decode(reader, reader.uint32());
          break;
        case 3:
          message.events.push(Event.decode(reader, reader.uint32()));
          break;
  ...
  fromJSON(object: any): ResponseEndBlock {
    return {
      ...
      consensusParamUpdates: isSet(object.consensusParamUpdates)
        ? ConsensusParams1.fromJSON(object.consensusParamUpdates)
        : undefined,
      events: Array.isArray(object?.events) ? object.events.map((e: any) => Event.fromJSON(e)) : [],
    };
  },
  ...
  toJSON(message: ResponseEndBlock): unknown {
    ...
    message.consensusParamUpdates !== undefined && (obj.consensusParamUpdates = message.consensusParamUpdates
      ? ConsensusParams1.toJSON(message.consensusParamUpdates)
      : undefined);
    if (message.events) {
      obj.events = message.events.map((e) => e ? Event.toJSON(e) : undefined);
    } else {
  ...
  fromPartial<I extends Exact<DeepPartial<ResponseEndBlock>, I>>(object: I): ResponseEndBlock {
    ...
    message.consensusParamUpdates =
      (object.consensusParamUpdates !== undefined && object.consensusParamUpdates !== null)
        ? ConsensusParams1.fromPartial(object.consensusParamUpdates)
        : undefined;
    message.events = object.events?.map((e) => Event.fromPartial(e)) || [];
    return message;
  },
