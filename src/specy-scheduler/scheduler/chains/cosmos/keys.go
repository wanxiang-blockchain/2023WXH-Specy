...
import (
	...
	"github.com/cosmos/relayer/v2/scheduler/chains/cosmos/keys/sr25519"
	"github.com/cosmos/relayer/v2/scheduler/codecs/ethermint"
	"github.com/cosmos/relayer/v2/scheduler/codecs/injective"
...
func (cc *CosmosProvider) KeyExists(name string) bool {
	fmt.Printf("KeyExists... Keybase:%+v, name:%s \n", cc.Keybase, name)
